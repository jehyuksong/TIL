...
- 1일 1프로젝트 15일차 LocalStorage 프로젝트를 하면서 공부했다.
- 동영상 강의를 보면서 리액트 공부를 했다.
- 얼굴이랑 다리에 점을 빼고 왔다.
...
- 점 빼는거나 수술하는 건 항상 제대로 못씻는다는게 너무 싫다 ㅠㅠ
...
# semantic ui 를 이용한 loading spinner
...
- 데이터를 가져오는 등의 시간이 필요한 화면에서 돌아가는 회전 로딩을 구현해서 사용한다.
